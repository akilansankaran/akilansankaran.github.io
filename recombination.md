...
<ul style="list-style-type: square; margin-left: 1.2em;">
  <li>While at Sandia, I developed a first-principles approach for point defect modeling under <a href="https://journals.aps.org/prl/abstract/10.1103/PhysRevLett.35.1525">seminal theories of electron and hole capture</a>, allowing for <a href="https://www.sciencedirect.com/science/article/abs/pii/S0010465521001685">improvements on Density Functional Theory (DFT) simulations</a> of transition probabilities.</li>
  <li>I developed a transition-state model for the relaxation process involved in electron and hole capture, and discussed the effects of anharmonicity and multidimensionality in the governing potentials when informing transition rate calculations.</li>
